...
@section('content')
    ...
    <div class="tag_container tag_add">
        ...
        <div class="item_container">
            ...
            <div class="item">
                <label>来源</label>
                <input type="text" name="source" id="source" value="jianxiu" disabled/>
            </div>
        </div>
        ...
        @foreach($tags as $K=>$V)
            ...
            @if($V->group_id==0)
                ...
                <div class="top_tag tag tag_container" id="{{$V->_id}}" group_id="{{$V->group_id}}" data-tag="{{$V->name}}">
            ...
            @elseif(in_array($V->group_id,$array_first))
                ...
                <script>
                    $(function () {
                        var html = '<div class="first_tag tag" id=<?php echo $V->_id;?> data-tag="{{$V->name}}"><span class="first_tag_label tag"><?php echo $V->name; ?></span></div>'
